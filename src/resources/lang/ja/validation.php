...
return [
    ...
    */
    ...
    'gt' => [
        ...
        'string' => ':attributeは:valueより多い文字数である必要があります。',
        'array' => ':attributeは:valueより多い要素数である必要があります。',
    ],
    'gte' => [
        'numeric' => ':attributeは:value以上の数字である必要があります。',
        'file' => ':attributeは:value KB以上である必要があります。',
        'string' => ':attributeは:value以上の文字数が必要です。',
        'array' => ':attributeは:value以上の要素数が必要です。',
    ],
    ...
    'lt' => [
        'numeric' => ':attributeは:valueより小さい数字である必要があります。',
        'file' => ':attributeは:value KBより小さい必要があります。',
        'string' => ':attributeは:valueより少ない文字数である必要があります。',
        'array' => ':attributeは:valueより少ない要素数である必要があります。',
    ],
    'lte' => [
        'numeric' => ':attributeは:value以下の数字である必要があります。',
        'file' => ':attributeは:value KB以下である必要があります。',
        'string' => ':attributeは:value以下の文字数が必要です。',
        'array' => ':attributeは:value以下の要素数が必要です。',
    ],
    'max' => [
    ...
    'uuid' => ':attributeはグローバルに一意な識別子である必要があります。',
